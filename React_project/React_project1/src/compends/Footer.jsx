...
const Footer = () => {
    return (
        <>
            {/* main div */}
            <div className='bg-gray-300  w-full min-h-100 flex justify-center items-center flex-col'>

                {/* div inner */}
                <div className=' h-full flex justify-center flex-col lg:flex-row xl:flex-row 2xl:flex-row w-11/12 items-center bg-amber-40'>

                    {/* b1 */}
                    <div className='w-1/3 h-10/12 flex items-center  lg:items:left xl:itmes-left 2xl:items-left flex-col'>
                        ...
                        <div id='input' className='border-2 border-gray-500 flex justify-end items-center rounded-2xl h-8 min-w-2/4  '>
                    ...
                    {/* b2 */}
                    <div className='w-full h-10/12 flex justify-center  flex-col   items-center   lg:items-end xl:items-end 2xl:items-end'>
                        <ul >
                ...
                {/* bottom div */}
                <div className='w-11/12 h-1/4 flex justify-center  border-t-2 border-t-gray-400'>
